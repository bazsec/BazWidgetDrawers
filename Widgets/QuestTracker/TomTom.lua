-- QuestTracker: TomTom Integration
-- Sets a TomTom waypoint to the super-tracked quest's next objective.
-- The previous waypoint is removed before each new one so orphaned
-- arrows never accumulate. Silent no-op when TomTom isn't installed.
